...
<head>
  <meta charset="UTF-8">
  <title>Fala Galera Estudio</title>
  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">Fala Galera<br></span>
          <span class="text-2">Aprende Portugués de Manera Fácil.</span>
        </div>
      </div>
        ...
        <div class="login-form">
          ...
          <form action="index.php" id="login-form" method="post">
            <div class="input-boxes">
              <div class="input-box">
                ...
                <input type="email" name="email" placeholder="Ingresa tu correo electrónico" id='loginEmail' required>
              </div>
              <div class="input-box">
              ...
              <div class="text"><a id="forgotpassword">¿Olvidaste tu contraseña?ctrónico</a></div>
          ...
          <form action="index.php" id="forgotPassword-form" method="post" style="display:none;">
            ...
            <div class="input-boxes">
              <div class="input-box">
                <i class="fas fa-envelope"></i>
                <input type="email" name="email" id="forgotEmail" placeholder="Ingresa tu correo electrónico" required>
              </div>

              <div class="text" style="margin-bottom: 20px;display:flex">
                <a id="backToLogin">Iniciar Sesión</a>
              </div>
