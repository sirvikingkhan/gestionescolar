...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Falga Galera</a>
    ...
    <div class="see-payment">
      <div class="notice-body">
        <h2>Title:  </h2>
        <h5>Profesora's Name : Thais Carilone Da Silva</h5>
        <h5>Monto: $500</h5>
        <p>Fecha de pago: 22/oct/2024</p>
        <button id="paid">Pago Exitoso!</button>
      </div>
    </div>
  </body>
  </html>