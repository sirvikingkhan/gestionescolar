...
<head>
    ...
    <title>Escritorio Fala Galera</title>
        ...
        <aside>
            <div class="profile">
                ...
                <div class="about">
                    ...
                    ?><br>
                    <b><a href="buspanel.php">Bloqueado</a></b><br><br>
                     <br>
            ...
            <div class="timetable" id="timetable">
                ...
                <table id="myTable">
                    <tr class="header">
                        ...
                        <th style="width:40%;">Asistencia</th>
                    </tr>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($row['file'] != null) {
            echo "<a href='../noticeUploads/" . $row['file'] . "'><img src='file.svg' height='30px' width='30px'><p style='color:red;'>ver aviso</p></a>";
        }
