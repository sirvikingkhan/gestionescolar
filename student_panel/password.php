...
<p class="text-muted">Tu nueva contraseña debe ser diferente de las contraseñas utilizadas anteriormente.</p>
<div class="box">
...
<div class="button">
    <input type="submit" value="Guardar" class="btn" name="submit">
